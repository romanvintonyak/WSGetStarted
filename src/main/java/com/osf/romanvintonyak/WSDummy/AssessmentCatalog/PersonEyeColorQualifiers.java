...
/**
 * <p>Java class for PersonEyeColorQualifiers.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="PersonEyeColorQualifiers">
...
public enum PersonEyeColorQualifiers {
    ...
    PersonEyeColorQualifiers(String v) {
        value = v;
    }
    ...
    public static PersonEyeColorQualifiers fromValue(String v) {
        for (PersonEyeColorQualifiers c: PersonEyeColorQualifiers.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
